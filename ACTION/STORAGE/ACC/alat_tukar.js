require("../../OPTIONS/settings.js")
    const fs = require('fs')  
  let _inventoryOrang = JSON.parse(fs.readFileSync('./ACTION/STORAGE/ADD/inventory.json'))
  ...
  const addInventori = (sender) => {
        ...
        fs.writeFileSync('./ACTION/STORAGE/ADD/inventory.json', JSON.stringify(_inventoryOrang))
   }
